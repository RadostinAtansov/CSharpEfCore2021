...
namespace MiniORM
{
	public abstract class DbContext
    {
        ...
        public void SaveChanges()
        {
            ...
            foreach (IEnumerable<object> dbSet in dbSets)
            {
                ...
                using (new ConnectionManager(this.connection))
                {
                    ...
                    {
                        foreach (IEnumerable dbset1 in dbSets)
                        {
                            var dbSetType = dbset1.GetType()
                                .GetGenericArguments()
                                .First();
                            ...
                            try
                            {
                                persistMethod.Invoke(this, new object[] { dbset1 });
                            }
            ...
            where TCollection : class, new()
        {
            ...
            PropertyInfo foreingKey = entityType
                .GetProperties()
            ...
            {
                object primaryKeyValue = foreingKey.GetValue(entity);
